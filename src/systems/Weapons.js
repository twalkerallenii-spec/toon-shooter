...
export const WEAPONS = [
  ...
  { key: 'SuperGun', model: 'Shotgun', ico: '🔵', rarity: 'legendary', label: 'Super Gun', damage: 0, fireRate: 1.3, mag: 6, spread: 0.01, pellets: 1, auto: false, range: 200, reload: 1.6, adsFov: 60, recoil: 0.2, projectile: 'energy', energyMode: 'orb', energyTier: 1, energyColor: 0x44aaff, tracer: 0x44aaff, secret: true },
  // ---- God-tier Armory weapons (indices 14-24): each does something DIFFERENT.
  { key: 'Plasma',   model: 'Shotgun', ico: '🟢', rarity: 'legendary', label: 'Plasma Cannon',      damage: 0, fireRate: 1.6, mag: 8,  spread: 0.01, pellets: 1, auto: false, range: 300, reload: 1.4, adsFov: 60, recoil: 0.18, projectile: 'energy', energyMode: 'spread',    energyTier: 3,  energyColor: 0x66ffcc, tracer: 0x66ffcc, secret: true }, // 3-orb spread
  { key: 'Ion',      model: 'Shotgun', ico: '🔷', rarity: 'legendary', label: 'Ion Storm',          damage: 0, fireRate: 2.0, mag: 10, spread: 0.01, pellets: 1, auto: false, range: 320, reload: 1.4, adsFov: 60, recoil: 0.16, projectile: 'energy', energyMode: 'chain',     energyTier: 3,  energyColor: 0x66ccff, tracer: 0x66ccff, secret: true }, // chain lightning
  { key: 'Void',     model: 'Shotgun', ico: '🟣', rarity: 'legendary', label: 'Void Ripper',        damage: 0, fireRate: 1.2, mag: 12, spread: 0.01, pellets: 1, auto: false, range: 340, reload: 1.3, adsFov: 60, recoil: 0.15, projectile: 'energy', energyMode: 'blackhole', energyTier: 4,  energyColor: 0xaa66ff, tracer: 0xaa66ff, secret: true }, // black hole
  { key: 'Nova',     model: 'Shotgun', ico: '🌸', rarity: 'legendary', label: 'Nova Blaster',       damage: 0, fireRate: 1.4, mag: 16, spread: 0.01, pellets: 1, auto: false, range: 360, reload: 1.3, adsFov: 60, recoil: 0.14, projectile: 'energy', energyMode: 'nova',      energyTier: 5,  energyColor: 0xff66aa, tracer: 0xff66aa, secret: true }, // radial nova
  { key: 'Singular', model: 'Shotgun', ico: '🟪', rarity: 'legendary', label: 'Singularity Gun',    damage: 0, fireRate: 0.8, mag: 20, spread: 0.01, pellets: 1, auto: false, range: 380, reload: 1.2, adsFov: 60, recoil: 0.12, projectile: 'energy', energyMode: 'well',      energyTier: 6,  energyColor: 0x9966ff, tracer: 0x9966ff, secret: true }, // gravity well
  { key: 'Antimat',  model: 'Shotgun', ico: '🔴', rarity: 'legendary', label: 'Antimatter Rifle',   damage: 0, fireRate: 2.5, mag: 24, spread: 0.01, pellets: 1, auto: false, range: 600, reload: 1.2, adsFov: 60, recoil: 0.11, projectile: 'energy', energyMode: 'rail',      energyTier: 7,  energyColor: 0xff4444, tracer: 0xff4444, secret: true }, // railgun line
  { key: 'Quasar',   model: 'Shotgun', ico: '🟠', rarity: 'legendary', label: 'Quasar Cannon',      damage: 0, fireRate: 1.2, mag: 30, spread: 0.01, pellets: 1, auto: false, range: 420, reload: 1.1, adsFov: 60, recoil: 0.10, projectile: 'energy', energyMode: 'meteor',    energyTier: 8,  energyColor: 0xffaa33, tracer: 0xffaa33, secret: true }, // meteor storm
  { key: 'Hyper',    model: 'Shotgun', ico: '🟦', rarity: 'legendary', label: 'Hyperbeam',          damage: 0, fireRate: 1.0, mag: 40, spread: 0.01, pellets: 1, auto: false, range: 500, reload: 1.0, adsFov: 60, recoil: 0.09, projectile: 'energy', energyMode: 'beam',      energyTier: 9,  energyColor: 0x33ffff, tracer: 0x33ffff, secret: true }, // wide cone beam
  { key: 'Apoc',     model: 'Shotgun', ico: '🟥', rarity: 'legendary', label: 'Apocalypse',         damage: 0, fireRate: 0.7, mag: 50, spread: 0.01, pellets: 1, auto: false, range: 480, reload: 1.0, adsFov: 60, recoil: 0.08, projectile: 'energy', energyMode: 'storm',     energyTier: 10, energyColor: 0xff2200, tracer: 0xff2200, secret: true }, // map-wide meteor rain
  { key: 'Omega',    model: 'Shotgun', ico: '⚪', rarity: 'legendary', label: 'Omega Annihilator',   damage: 0, fireRate: 0.6, mag: 80, spread: 0.01, pellets: 1, auto: false, range: 500, reload: 0.9, adsFov: 60, recoil: 0.06, projectile: 'energy', energyMode: 'omega',     energyTier: 11, energyColor: 0xffffff, tracer: 0xffffff, secret: true }, // giant shockwave
  { key: 'WorldEnd', model: 'Shotgun', ico: '🌍', rarity: 'legendary', label: 'World Annihilator',   damage: 0, fireRate: 0.4, mag: 99, spread: 0.01, pellets: 1, auto: false, range: 500, reload: 1.0, adsFov: 60, recoil: 0.25, projectile: 'energy', energyMode: 'worldend',  energyTier: 12, energyColor: 0xff00aa, tracer: 0xff00aa, secret: true }, // deletes EVERYTHING
]
